...
const source = 'Source: https://www.worldometers.info/coronavirus/',
      ...
      ansiTwitter = cyanBG(black(twitterhandle)),
...
exports.plainglobaltracker = (c, d, r, u) => {
    ...
    "${randomSay()}"
    `;
    const defaultfooter = br+tab+line+br+tab+bmcline+br+tab+'(Buy Me A Coffee) '+bmcurl+br+tab+line+br+tab+twitterline+br+tab+twitterhandle+br+br;
...
exports.plaincountrytracker = (n, c, tC, d, tD, r, a, cl, cPOM, u) => {
    ...
    `;
    const defaultfooter = br+tab+line+br+tab+bmcline+br+tab+'(Buy Me A Coffee) '+bmcurl+br+tab+line+br+tab+twitterline+br+tab+twitterhandle+br+br,
          specialfooter = br+tab+line+br+tab+bmcline+br+tab+'(GCash) '+gcashNum+br+tab+'(Buy Me A Coffee) '+bmcurl+br+tab+line+br+tab+twitterline+br+tab+twitterhandle+br+br;
